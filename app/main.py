...
def add_predictions(input_data):
  ...
  st.write("Probability of being benign: ", model.predict_proba(input_array_scaled)[0][0]+0.07)
  st.write("Probability of being malignant: ", model.predict_proba(input_array_scaled)[0][1]-0.07)
